...
- Champs totalement inutilisés dans `ReactorControllerBlockEntity` (`pattern`, `liquidLife`, masqués par `@SuppressWarnings("unused")`) et classe morte de bout en bout `FluidConsumable`.
